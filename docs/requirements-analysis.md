...
|--------|-----|-----------------|
| Authentication | FR-01 – FR-04 | Registration, login, role identification, access enforcement |
| Complaint Management | FR-05 – FR-15 | Full complaint lifecycle from submission to closure |
