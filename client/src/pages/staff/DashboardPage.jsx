    ...
    <div style={{ fontFamily: 'sans-serif', minHeight: '100vh', background: '#f8fafc' }}>
      <nav style={{ background: '#fff', borderBottom: '1px solid #e2e8f0', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          <Link to="/staff/complaints">My Tasks</Link>
      ...
      <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#64748b' }}>Welcome, {user?.name} | {user?.staffCategory}</p>
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '1.5rem' }}>
          {['Assigned','In Progress','Resolved'].map((label) => (
            <div key={label} style={{ background: '#fff', borderLeft: '4px solid #059669', borderRadius: '6px', padding: '1.25rem', minWidth: '180px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
